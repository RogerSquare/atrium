...
const {
  ...
  SETTINGS_FILE, SERVICES_FILE, PROJECTS_FILE, WORKSPACES_FILE,
...
module.exports = {
  ...
  INSTRUCTIONS_FILE, CLAUDE_LOCAL_FILE, JWT_SECRET, TRASH_DIR, ARCHIVED_DIR, PROJECTS_FILE, WORKSPACES_FILE, LOOPS_FILE, LOOP_RUNS_DIR, MAX_LOOP_RUNS_PER_LOOP, LOOP_TEMPLATES_FILE, APPROVALS_DIR,
